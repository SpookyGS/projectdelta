--[[
	...
	Wall Hack Module [NitroHub] by Spooky © Nitro Operations(2023)

	https://github.com/SpookyGS
...
if not getgenv().NitroHub or getgenv().NitroHub.WallHack then return end
...
local Environment = getgenv().NitroHub.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().NitroHub.WallHack.Functions = nil
	getgenv().NitroHub.WallHack = nil
