--[[
	...
	Aimbot Module [NitroHub] by Spooky © Nitro Operations(2023)
...
if not getgenv().NitroHub or getgenv().NitroHub.Aimbot then return end
...
local Environment = getgenv().NitroHub.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().NitroHub.Aimbot.Functions = nil
	getgenv().NitroHub.Aimbot = nil
